...
bukkit {
    ...
    author = "DevSrSouza"
    website = "kotlinminecraft.github.io"
    depend = listOf("KotlinBukkitAPI")

    description = "A home plugin using KotlinBukkitAPI."
}
